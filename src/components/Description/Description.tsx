...
const Description = () => {
  ...
  return (
    ...
    <section className="flex flex-col md:flex-row w-full text-fg gap-5" ref={containerRef}>
      {/* Left Content Side */}
      ...
      <ParallaxImage image="/images/update_images/godot_show/godot_show_7.webp" alt="Portrait of Seyi" containerStyle="w-full md:w-1/2 min-h-[50vh]" containerRef={containerRef} />
    </section>
  );  
};
